...
export async function seedQuestions(db: SQLite.SQLiteDatabase) {
  await db.runAsync(
    ...
    ['q1', 'Qual é a capital do Brasil?', 'text']
  )
  await db.runAsync(
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q3', 'Qual linguagem de programação é usada no React Native?', 'text']
  )
  await db.runAsync(
    `INSERT INTO correct_answer (id, question_id, value) VALUES (?, ?, ?)`,
    ['ca3', 'q3', 'JavaScript']
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q4', 'Qual é o maior planeta do sistema solar?', 'text']
  )
  await db.runAsync(
    `INSERT INTO correct_answer (id, question_id, value) VALUES (?, ?, ?)`,
    ['ca4', 'q4', 'Júpiter']
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q5', 'Qual empresa desenvolveu o sistema operacional Android?', 'text']
  )
  await db.runAsync(
    `INSERT INTO correct_answer (id, question_id, value) VALUES (?, ?, ?)`,
    ['ca5', 'q5', 'Google']
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q6', 'Qual é o nome do framework CSS utilitário mais popular no mundo?', 'text']
  )
  await db.runAsync(
    `INSERT INTO correct_answer (id, question_id, value) VALUES (?, ?, ?)`,
    ['ca6', 'q6', 'Tailwind CSS']
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q7', 'Qual planeta é conhecido como o planeta vermelho?', 'select']
  )
  await db.runAsync(
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q8', 'Qual das opções é uma linguagem de programação compilada?', 'select']
  )
  await db.runAsync(
    `INSERT INTO question_option (id, question_id, label, value) VALUES (?, ?, ?, ?)`,
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q9', 'Qual é o protocolo base da comunicação na internet?', 'select']
  )
  await db.runAsync(
    `INSERT INTO question_option (id, question_id, label, value) VALUES (?, ?, ?, ?)`,
    ['opt_q9_1', 'q9', 'FTP', 'ftp']
  ...
  await db.runAsync(
    `INSERT INTO question (id, title, type) VALUES (?, ?, ?)`,
    ['q10', 'Qual gerenciador de pacotes é nativo do Node.js?', 'select']
  )
  await db.runAsync(
    `INSERT INTO question_option (id, question_id, label, value) VALUES (?, ?, ?, ?)`,
